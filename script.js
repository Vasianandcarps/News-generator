...
let we = ["в середземье", "в речке", "в чашке", "на холме", "возле башни"];
let wi = ["странный", "пугающий", "зеленый", "веселый", "пятнистый"];
let wo = ["змей", "хоббит", "человек", "конь", "петикантроп"];
let wa = ["стел печенье", "уронил пирожок", "украл вазу", "потерял ключи", "укусил стену"];
let wd = ["Печеньки умерли", "Конь убежал", "Глаз Саурона проснулся", " Пошел дождь", "Пришлось лечиться"];
let wp = ["Какой ужас", "Ничего такого", "За Середземье", "Неожиданно", "Вот блин"];
